...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2026 at 01:22 AM
...
CREATE TABLE `courses` (
  ...
  `robotics_kit_id` bigint(20) UNSIGNED NOT NULL,
...
(3, '2026_03_09_235048_create_groups_table', 1),
(4, '2026_03_09_235050_create_users_table', 1),
(5, '2026_03_09_235057_create_robotics_kits_table', 1),
(6, '2026_03_09_235102_create_courses_table', 1),
(7, '2026_03_09_235111_create_course_group_table', 1);
...
ALTER TABLE `course_group`
  ADD PRIMARY KEY (`id`),
  ADD KEY `course_group_course_id_foreign` (`course_id`),
  ADD KEY `course_group_group_id_foreign` (`group_id`);
...
--
-- Indexes for table `robotics_kits`
--
...
--
-- AUTO_INCREMENT for table `robotics_kits`
--
ALTER TABLE `robotics_kits`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
